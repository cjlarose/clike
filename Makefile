...
COMPONENTS = env.c semantics.c declarations.c expressions.c str_table.c statements.c procedure.c ir.c instruction.c ir_expression.c ir_statement.c
...
instruction_test: $(TEST_DIR)/test_instruction.c $(BUILD_DIR)/instruction.o nitty_gritty
	gcc -g -I include -I $(TEST_DIR)/include -I nitty_gritty/include $(BUILD_DIR)/instruction.o $(NITTY_GRITTY_OBJS) $(TEST_DIR)/test_instruction.c
